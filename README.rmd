...
> Sparks, A.H., Del Ponte, E.M., Everhart, S., Foster, Z., Grünwald, N., (`r format(Sys.Date(), "%Y")`). _Compendium of R code and data for 'Status and Best Practices for Reproducible Research In Plant Pathology'_. Accessed `r format(Sys.Date(), "%d %b %Y")`. Online at <https://doi.org/10.5281/zenodo.1250665>
