...
The top-level "/analysis" directory contains the directories and files necessary to reknit the MS Word document of the paper from an Rmd file, "/analysis/paper/paper.Rmd".

A script, `knit_paper.R` is located in `analysis/paper/knit_paper.R` that will knit the Word document
...
Level 5, 1 Nash St Perth WA 6000
