...
* [Fork](https://github.com/openplantpathology/Reproducibility_in_Plant_Pathology/#fork-destination-box) the repository on GitHub to make a copy of the repository on your account. Or use this line in your shell terminal:
