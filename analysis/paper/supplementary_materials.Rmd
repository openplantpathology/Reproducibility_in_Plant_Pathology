...
m_f1_es <- c(m_f1_es, rep(NA, nrow(as_tibble(m_f1_report)) - length(m_f1_es)))
...
m_f2_es <- c(m_f2_es, rep(NA, nrow(as_tibble(m_f2_report)) - length(m_f2_es)))
...
m_g1_es <- c(m_g1_es, rep(NA, nrow(as_tibble(m_g1_report)) - length(m_g1_es)))
...
m_g2_es <- c(m_g2_es, rep(NA, nrow(as_tibble(m_g2_report)) - length(m_g2_es)))
...
m_h1_es <- c(m_h1_es, rep(NA, nrow(as_tibble(m_h1_report)) - length(m_h1_es)))
...
m_h2_es <- c(m_h2_es, rep(NA, nrow(as_tibble(m_h2_report)) - length(m_h2_es)))
m_h2_es <- gsub("\\s*\\([^\\)]+\\)", "", as.character(m_h2_es))
