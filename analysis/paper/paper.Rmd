...
This was downloaded, saved as an Open Document Spreadsheet (ODS) file and is left-joined with the article notes using a `left_join()` from the 'dplyr' package [@Wickham2020] for analysis when a custom function for this analysis, `import_notes()`, was executed.
...
However, more articles, 29 or 9.7%, scored '3' than '1' or '2' combined, with two articles not producing shareable data (Figure \@ref(fig:articleScores)D).
