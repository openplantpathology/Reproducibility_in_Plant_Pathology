...
However, the null hypothesis that the year of publication did not have an effect on the availability of data was accepted (Figure \@ref(fig:year-parameters)B, Table S4; Figure S5).
