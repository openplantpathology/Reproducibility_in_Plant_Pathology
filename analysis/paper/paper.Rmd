...
The statistical analysis was performed using R version `r version$version.string` [@RCT2022] on an Apple MacBook Pro (13-inch, M1, 2020) using R 4.1.0 (R Core Team, 2021).
