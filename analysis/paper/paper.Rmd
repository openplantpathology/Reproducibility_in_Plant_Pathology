...
To predict the responses with publishing journal (abbreviation was used throughout) the formula took the form: response ~ abbreviation and the models included assignee as a random effect (formula: ~1 | assignee).
