...
For a full description of all parameters details see (XXXXXX).
...
Publications in three journals, Crop Protection, Plant Disease and Revista Mexicana de Fitopatología were not likely to share their data and so can be considered significant but no effects were detectable in any other journal titles.
