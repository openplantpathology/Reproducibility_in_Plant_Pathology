...
readODS::read_ods(
  ...
  autofit() %>%
  set_caption(
    "Articles were three in two areas for reproducibility on a scale of '0' to '3' by five independent evaluators to rank articles in each of two areas, 'Computational Methods Availability' and 'Data Availability'.")
```
