...
The most frequently cited software was `r names(which.max(table(rrpp$software_used)))`.
Other statistical software packages were frequently cited, SPSS (3rd) R (4th), GenStat and STATISTICA (7th).
