...
necessary to replicate model development and the subsequent study on the effects of climate change on potato late blight.

* Lehner et al. [-@Lehner2017] provide data and a reproducible report that explains in detail all steps of the analysis and the R codes for conducting a meta-analysis for assessing heterogeneity in the relationship between white mold incidence and soybean yield and between incidence and soybean tied (https://emdelponte.github.io/paper-white-mold-meta-analysis/).
...
The use of programming or scripting languages such as R, SAS or Python enables you as a scientist to keep very detailed records of what was computationally performed.
