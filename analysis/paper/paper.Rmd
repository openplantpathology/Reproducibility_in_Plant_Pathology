...
Models 5 and 6 were used to predict the responses using a continuous value, IF_5year, as the predictor, (formula: response&nbsp;\~&nbsp;IF_5year) and included assignee as random effect (formula:&nbsp;\~1&nbsp;\|&nbsp;assignee) without journal as a random effect to mitigate correlation between impact factor and the journal of publication.
