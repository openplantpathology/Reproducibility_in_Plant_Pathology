...
a <- plot(equivalence_test(m_g1), show_labels = TRUE) + 
  scale_colour_grey() +
  ggtitle("Code")

b <- plot(equivalence_test(m_g2), show_labels = TRUE) + 
  scale_colour_grey() +
   theme(
      axis.text.y = element_blank(),
      axis.ticks.y = element_blank(),
...
a <- plot(equivalence_test(m_h1), show_labels = TRUE) + 
  scale_colour_grey() +
  ggtitle("Code")

b <- plot(equivalence_test(m_h2), show_labels = TRUE) + 
  scale_colour_grey() +
   theme(
      axis.text.y = element_blank(),
      axis.ticks.y = element_blank(),
