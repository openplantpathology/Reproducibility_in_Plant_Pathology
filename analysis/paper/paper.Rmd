...
Where possible, the software used in conducting the research behind the publication was recorded in the notes if it was cited or otherwise specified in the article text.
...
In some cases the `software_avail`, or the openness of the software used, score did not agree with the software that was recorded and these scores were modified after discussion to match the agreed on ratings based on the record of the software that was used in each respective paper.
...
Inter-rater differences were evaluated using percent agreement and Fliess' Kappa [ZZZZ cite emerson here]
The software availability, computational methods availability and data availability scores were converted from 0-3 to 1-4 ordinal score values and Bayesian mixed-effect models were fit using the contributed package 'brms' (version `r packageVersion("brms")`) [@Burkner2017; @Burkner2018; @Burkner2021] to evaluate the fixed effects of the publication (journal title), five-year journal impact factor, journal open access policy, journal data and code deposition instructions.
