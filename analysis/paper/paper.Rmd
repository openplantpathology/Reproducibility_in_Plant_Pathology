...
The remainder of the top ten programs we found were related to sequence analysis, *i.e.*, Clustal (`r scales::ordinal(which(tab_s == "CLUSTAL"))`), BLAST ((`r scales::ordinal(which(tab_s == "BLAST"))`)), and BioEdit ((`r scales::ordinal(which(tab_s == "BIOEDIT"))`)) or phylogenetic analysis MrBayes ((`r scales::ordinal(which(tab_s == "MRBAYS"))`)).
