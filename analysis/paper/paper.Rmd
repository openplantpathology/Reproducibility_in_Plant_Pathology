...
This approach assumed that there was no effect or bias on reproducibility based on the time of year that an article was published since most journals start with page number one at the beginning of the year and some journals, _e.g._, _Phytopathology_(R) have focus issues with invited authors.
