...
Making the raw data FAIR means providing proper metadata for the resource.
The metadata define the resource that has been made available allowing for discovery and use by other interested parties.
