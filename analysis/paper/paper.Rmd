...
There was no effect detected for year when predicting the availability of computational methods (Figure \@ref(fig:year-parameters)A, Table S3, Figure S4).
However, 2018 was clearly different with more data being made available than all other years (Figure \@ref(fig:year-parameters)B, Table S4; Figure S5).
