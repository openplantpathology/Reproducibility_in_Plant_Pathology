...
When making our science more open and reproducible, methods, software used (this includes items such as R, Julia or Python packages that were directly used in the analysis or production of the paper, etc.) should be cited properly.
...
This also helps to ensure that we researchers can reconstruct what we have done since we will have good notes and documentation and be able to identify if something changes, *e.g.*, a package version, what effect it had on our research.
