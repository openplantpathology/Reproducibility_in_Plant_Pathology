...
-   **software available**
    ...
    -   1 - Uses expensive proprietary software that only institutions would typically purchase (*i.e.*, ArcGIS standard is \$7000US)
...
Their research compendium provides a Docker instance, DOI and full R package that enable readers to fully replicate their analysis of chickpea ascochyta conida dispersal using the data collected and stepping through other points where weather data were investigated and various models were fit before deciding on the best fit and recreate any figures as published in the article [@Khaliq2020a].
