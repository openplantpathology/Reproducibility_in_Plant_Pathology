...
For instance, reproducible research was recently highlighted by many authors [@Tiwari_2021; @preeyanon2018; @Wallach2018; @Baker2016a; @Iqbal2016; @Nature2016; @Patil2016; @Weissgerber2016; @Brunsdon2015; @Sweedler2015; @Fitzjohn2014; @Ioannidis2014; @Fidler2013; @Stodden2013] as an important issue.
...
Second, it is beneficial to the reviewer in understanding and providing suggestions for improvements when reviewing and the end-user or reader to be able to verify the validity of the methods used and recreate the analysis which helps with knowledge transfer.
Lastly, sharing work openly and making it discoverable can lead to new collaborations. 
end edit portion -->
...
extrafont::embed_fonts(
   ...
   outfile = ("figures/Sparks et al Figure 2eps"),
   options = "-dEPSCrop"
)
