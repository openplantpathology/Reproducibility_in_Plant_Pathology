...
While sharing code and data for computational reproducibility is important, it is not substituted by the other practices and eventually researchers fail to provide sufficient description or correct citations.
...
To help create a good set of data and code that can easily be shared, the use of programming or scripting languages such as R, Julia, SAS or Python enables us scientists to keep very detailed records of what was computationally performed.
...
Other providers exist that allow for us to not only track changes but also to share the data openly, these include GitHub, Gitlab and Bitbucket and GitHub is arguably the most popular and widely used open-source software development platform currently.
