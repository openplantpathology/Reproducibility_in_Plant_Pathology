...
distinct(rrpp, journal, IF_5year) %>%
  ...
  autofit() %>%
  set_caption(
    "Journal titles selected for inclusion, their respective five year impact factors as of 2022 and the number (n) of articles from each journal that were evaluated."
  )
```
