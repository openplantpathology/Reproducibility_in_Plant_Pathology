...
Model finesses were evaluated using model summaries and diagnostic plots from 'brms' (version 2.15.0) [@Burkner2018] and posterior fits using `pp_check()` from the contributed R package 'bayesplot' (version 1.8.1) [@Gabry2019].
