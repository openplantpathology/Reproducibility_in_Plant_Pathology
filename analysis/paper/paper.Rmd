...
For instance, reproducible research is recently highlighted by many authors [@preeyanon2018; @Wallach2018; @Baker2016a; @Iqbal2016; @Nature2016; @Patil2016; @Weissgerber2016; @Brunsdon2015; @Sweedler2015; @Fitzjohn2014; @Ioannidis2014; @Fidler2013; @Stodden2013;] as an important issue.
...
In biological sciences it is not always possible to use identical test material or perhaps the the time or resources are not available for full reproduction, _e.g._, field trials that span years and locations or complex glasshouse experiments.
