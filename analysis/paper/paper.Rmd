...
import_notes() %>%
  ...
  autofit() %>%
  set_caption(
    "Tally of reproducibility scores where '0' is not reproducible and '12' is fully reproducible, e.g., all software cited, software used are freely available to anyone, computational methods (statistical analysis or other computational code) are freely available for download and use, and raw data are available for download and use."
  )
```
