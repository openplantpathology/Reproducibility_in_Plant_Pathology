...
author:
  ...
  - Niklaus J Grünwald: 
      institute: ARS
institute:
  - DPIRD: Department of Primary Industries and Regional Development, East Perth, Western Australia, Australia
...
For instance, reproducible research is recently highlighted by many authors [@Baker2016a; @Iqbal2016; @Nature2016; @Patil2016; @Weissgerber2016; @Brunsdon2015; @Sweedler2015; @Fitzjohn2014; @Ioannidis2014; @Fidler2013; @Stodden2013] as an important issue.
...
A total reproducibility score was calculated as the per cent of total possible for a given paper. However, some papers did not use specialized software therefore they were not scored for this category.
