...
For the the publishing journal (abbreviation was used throughout) (formula: response ~ abbreviation) and the models included assignee and year as random effects (formula: list(~1 | assignee, ~1 | year)).
The effects of year were predicted as (formula: response ~ year) and the models included abbreviation and assignee as random effects (formula: list(~1 | abbreviation, ~1 | assignee)).
