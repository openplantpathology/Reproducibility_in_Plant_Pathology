...
We propose that use of open-source tools facilitates computationally reproducible work and analyzes benefitting not just readers, but the authors as well.
