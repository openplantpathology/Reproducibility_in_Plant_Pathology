...
All authors agreed on the evaluation of the data availability of all five articles that were scored by each author (Figure \@ref(fig:irCriteria)A) but one of the authors rated one article as `NA` or no computational methods used rather than zero as with the other four authors (Figure \@ref(fig:irCriteria)B), giving the interrater percent agreement a score of 100% with the `NA value dropped from the code availability.
...
scoring_criteria %>%
  ...
  set_caption(
    "Articles were scored in four areas for reproducibility on a scale of '0' to '3' by five independent evaluators to rank articles in each of four areas, 'Computational methods availability', 'Data availability', 'Software availability' and 'Software citation'.")
```
...
load(file = here("inst/extdata/m_f1.Rda"))
load(file = here("inst/extdata/m_f2.Rda"))
load(file = here("inst/extdata/m_f3.Rda"))
load(file = here("inst/extdata/m_g1.Rda"))
load(file = here("inst/extdata/m_g2.Rda"))
load(file = here("inst/extdata/m_g3.Rda"))
load(file = here("inst/extdata/m_h1.Rda"))
load(file = here("inst/extdata/m_h2.Rda"))
load(file = here("inst/extdata/m_h3.Rda"))
load(file = here("inst/extdata/m_i1.Rda"))
load(file = here("inst/extdata/m_i2.Rda"))
load(file = here("inst/extdata/m_i3.Rda"))
load(file = here("inst/extdata/m_j1.Rda"))
load(file = here("inst/extdata/m_j2.Rda"))
load(file = here("inst/extdata/m_j3.Rda"))
load(file = here("inst/extdata/m_k1.Rda"))
load(file = here("inst/extdata/m_k2.Rda"))
