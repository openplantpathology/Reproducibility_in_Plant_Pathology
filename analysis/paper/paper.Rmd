...
There was no detectable effect or non-effect for year when predicting the availability of computational methods (Figure \@ref(fig:year-parameters)A, Table S3, Figure S4).
However, the year of publication did not have an effect on the availability of data (Figure \@ref(fig:year-parameters)B, Table S4; Figure S5).
