...
The overall reproducibility scores assigned by authors to the five articles evaluated to check for inter-rater differences had moderate reliability, 0.57, (Table \@ref(tab:icc), Figure \@ref(fig:irReproScore)).
...
```{r icc, echo=FALSE, message=FALSE, warning=FALSE}
ir %>%
  ...
  flextable() %>%
  set_table_properties(layout = "autofit") %>% 
  set_caption("this needs a caption")
```
