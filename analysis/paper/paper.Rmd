...
Bayesian mixed-effect models were fit using the contributed package 'brms' (version 2.15.0) [@Burkner2018] to evaluate the fixed effects of the publication (journal title), article class, molecular focus, five-year journal impact factor, journal open access policy on the reproducibility index and year to test for changes over time in the reproducibility index.
