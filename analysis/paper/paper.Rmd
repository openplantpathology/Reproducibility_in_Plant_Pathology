...
We fitted Bayesian logistic mixed models (estimated using MCMC sampling with 4 chains of 10000 iterations and a warmup of 5000 and thinning of 1) using the `cumulative(link = "probit")` family function for ordinal data using the contributed package 'brms' (version `r packageVersion("brms")`) [@Burkner2017; @Burkner2018; @Burkner2021].
...
```{r journal-parameters, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='I am so tired', cache=FALSE, fig.env='figure'}
...
```{r year-parameters, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='I am so tired', cache=FALSE, fig.env='figure'}
...
```{r IF-parameters, echo=FALSE, message=FALSE, warning=FALSE, fig.cap='I am so tired', cache=FALSE, fig.env='figure'}
