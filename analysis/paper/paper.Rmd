...
```
Two-hundred fifty three unique software applications were recorded as having been used in the articles that were evalutated.
These included desktop programs, web-based software and databases.
From the top ten most frequently cited software, the most frequently cited program was `r tab_s[1, 1]`, where different versions were not distinguished.
