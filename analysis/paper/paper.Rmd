...
To discuss the topic, it helps to first define what we mean so that we may clearly communicate.
...
Taking this approach even further, packaging the full analysis in a containerized software application, e.g., Docker is a way to help ensure computational reproducibility but at the expense of added complexity [@Merkel2014].
