---
title: "Third Round of Assigning Articles to Evaluators"
author: "Adam H. Sparks"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Third Round of Assigning Articles to Evaluators}
...
<<<<<<< HEAD
As a third round in response to reviewers' comments, we sampled 150 articles from the same 21 journals to bring the year coverage of articles up to 2021.
=======
As a third round in response to reviewers' comments, we sampled 150 additional articles from the same 21 journals to bring the coverage of articles up to 2021.
>>>>>>> main
