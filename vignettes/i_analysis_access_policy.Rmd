...
(m_i1_effect_size <- report_effectsize(m_i1))
```
...
(m_i2_effect_size <- report_effectsize(m_i2))
```
...
save(m_i1_effect_size, file = here("inst/extdata/m_i1_effectsize.Rda"))
save(m_i2_effect_size, file = here("inst/extdata/m_i2_effectsize.Rda"))
```
