...
Each article will be scored on a set of defined reproducibility criteria. We defined our scoring system for the articles as follows. 
...
Thus a perfect score would be 21, scoring three in all seven categories.
