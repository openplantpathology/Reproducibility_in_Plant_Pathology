...
ggplot(rrpp, aes(y = reproducibility_score,
                  x = reorder(factor(assignee), mean_assignee))) +
  geom_count() +
  stat_summary(
    fun = median,
    fun.min = median,
  ...
  ggtitle("Evaluator Scores Sorted by Their Respective Mean Scores") +
...
```{r comp_methods_score, message=FALSE}
...
```{r software_avail2, message=FALSE}
