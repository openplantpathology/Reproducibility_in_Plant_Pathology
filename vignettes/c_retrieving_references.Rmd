...
The DOI values were written to a text file and Zotero was used to fetch the refernence for the DOIs using the "Add Items by Identifier" by copy-pasting the string of DOIs from the text file into the search field.
