...
```{r join_files, warning=FALSE, message=FALSE, results="hide", eval=TRUE}
...
lapply(bib, write, paste0(tempdir(), "/notes.bib"), append = TRUE)
parsed_bib <- bib2df(paste0(tempdir(), "/notes.bib"))

bib_gs <- gs_new("bib_notes", ws_title = "bib_notes", input = parsed_bib,
...
The last few steps are completed outside of R in Google Docs, manually adding the missing articles to the spreadsheet.
