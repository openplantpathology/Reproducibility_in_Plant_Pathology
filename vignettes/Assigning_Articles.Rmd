...
bib <- RefManageR::GetBibEntryWithDOI(notes$doi) # from this package's data

# Join articles and references for saving to CSV for reference
article_assignments <- merge(notes, as.data.frame(bib), by = "doi")
...
(missing <- subset(notes, !(notes$doi %in% article_assignments$doi)))
...
devtools::use_data(article_assignments, overwrite = TRUE)
