...
(m_h1_effect_size <- report_effectsize(m_h1))
```
...
(m_h2_effect_size <- report_effectsize(m_h2))
```
...
save(m_h1_effect_size, file = here("inst/extdata/m_h1_effectsize.Rda"))
save(m_h2_effect_size, file = here("inst/extdata/m_h2_effectsize.Rda"))
```
