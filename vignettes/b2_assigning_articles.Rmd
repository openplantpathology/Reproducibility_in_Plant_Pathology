...
vignette: >
  %\VignetteIndexEntry{assigning_articles_second_round}
...
As a second round to bring the analysis up-to-date, we elected to sample 100 articles
from the same 21 journals for 2017-2018.

Aside from the different years, the journals remain the same and process as
...
These articles were added at a later date to look for any possible trends in
the plant pathology literature being published. The same journal titles were
sampled for 2017-2018 using the same protocols as the original set of 200
articles for 100 articles over two years.
...
DOIs to a gsheet, "article_notes_2017-2018" which will be imported to R in the next step.
...
the missing information to the spreadsheet and the new_assigneess adding their
