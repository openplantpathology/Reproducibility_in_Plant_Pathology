...
(m_f1_effect_size <- report_effectsize(m_f1))
```
...
(m_f2_effect_size <- report_effectsize(m_f2))
```
...
save(m_f1_effect_size, file = here("inst/extdata/m_f1_effectsize.Rda"))
save(m_f2_effect_size, file = here("inst/extdata/m_f2_effectsize.Rda"))
```
