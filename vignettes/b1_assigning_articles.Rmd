...
```{r org_assignees}
org_org_assigneess <- rep(c("Adam", "Emerson", "Zach", "Nik"), 50)
...
journals <- cbind(journals[, -1], year, contains_page, org_assignees)

journals <- arrange(.data = journals, org_assignees, journal, year, contains_page)
...
bib_df <- arrange(bib_df, org_assignees)
...
the missing information to the spreadsheet and the org_assigneess adding their
