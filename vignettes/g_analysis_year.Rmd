...
(m_g1_effect_size <- report_effectsize(m_g1))
```
...
(m_g2_effect_size <- report_effectsize(m_g2))
```
...
save(m_g1_effect_size, file = here("inst/extdata/m_g1_effectsize.Rda"))
save(m_g2_effect_size, file = here("inst/extdata/m_g2_effectsize.Rda"))
```
