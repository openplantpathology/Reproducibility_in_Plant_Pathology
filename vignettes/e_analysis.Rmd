...
The t.test indicates that the journal's open access status does not affect the reproducibility score.
...
The ANOVA indicates that the journals' instructions for authors concerning sharing data and reproducibility have no effect on the score assigned.
