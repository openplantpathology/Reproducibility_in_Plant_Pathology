...
ttestBF(formula = reproducibility_score ~ art_class, data = rrpp)
```
...
anovaBF(formula = reproducibility_score ~ abbreviation, data = rrpp)
```
...
anovaBF(formula = reproducibility_score ~ assignee, data = rrpp)
```
...
regressionBF(formula = reproducibility_score ~ IF_5year, data = rrpp)
```
...
ttestBF(formula = reproducibility_score ~ open, data = rrpp)
```
...
anovaBF(formula = reproducibility_score ~ repro_inst, data = rrpp)
```
